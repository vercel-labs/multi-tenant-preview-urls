      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        {isAllTenants ? (
          <>
            ...
            <div className="mt-4 space-y-2">
              {Object.entries(TENANTS)
                .filter(([id]) => id !== "all")
                .map(([id, t]) => {
                  const tenantUrl = host ? `https://${id}---${host}/` : "";
                  return (
                    <a
                      key={id}
                      href={tenantUrl}
                      className={`flex items-center justify-between rounded-lg border ${t.accent} px-4 py-3 transition-colors hover:bg-neutral-900`}
                    >
            ...
            <div className="mt-4 rounded-lg border border-neutral-800 bg-neutral-900/50 p-4">
              ...
              <p className="mt-2 text-sm text-neutral-300">
                ...
                before{" "}
                <code className="text-white bg-neutral-800 px-1.5 py-0.5 rounded">---</code>{" "}
                in your preview URL, and Vercel will still route the request to the correct deployment.
                Your code receives the full hostname, so you can extract the prefix and handle routing however you want.
              </p>
              <p className="mt-3 text-sm text-neutral-400">
                <strong className="text-neutral-300">Note:</strong> This feature requires a custom deployment URL suffix (e.g., <code className="text-neutral-300 bg-neutral-800 px-1 py-0.5 rounded text-xs">.vercel.dev</code>). 
                It does not work with the default <code className="text-neutral-300 bg-neutral-800 px-1 py-0.5 rounded text-xs">.vercel.app</code> suffix.
              </p>
            </div>
            ...
            <div className="mt-4 rounded-lg border border-neutral-800 bg-neutral-900/50 p-5">
              <div className="flex items-center justify-between mb-5">
                ...
                <button
                  type="button"
                  onClick={() => setPreviewUrlIndex((i) => (i + 1) % PREVIEW_URLS.length)}
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="rounded border border-blue-500/30 bg-blue-500/10 px-3 py-2">
                    <div className="text-[10px] uppercase tracking-wider text-blue-400 mb-1">1. User visits</div>
                  ...
                  <div className="flex justify-center">
                    <svg className="h-4 w-4 text-neutral-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                    </svg>
                  </div>
                  
                  <div className="rounded border border-neutral-700 bg-neutral-800/50 px-3 py-2">
                    <div className="text-[10px] uppercase tracking-wider text-neutral-400 mb-1">2. Vercel routes to deployment</div>
                  ...
                  <div className="rounded border border-neutral-700 bg-neutral-800/50 px-3 py-2">
                    <div className="text-[10px] uppercase tracking-wider text-neutral-400 mb-1">3. Your code receives</div>
                    <code className="text-xs text-neutral-300">
                      host: <span className="text-blue-400 font-semibold">acme</span>
                      <span className="text-neutral-600">---</span>
                  ...
                  <div className="rounded border border-emerald-500/30 bg-emerald-500/10 px-3 py-2">
                    <div className="text-[10px] uppercase tracking-wider text-emerald-400 mb-1">4. Your code handles routing</div>
                    <code className="text-xs text-neutral-300">
                      → /<span className="text-blue-400 font-semibold">acme</span>/*
                    </code>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="rounded border border-purple-500/30 bg-purple-500/10 px-3 py-2">
                    <div className="text-[10px] uppercase tracking-wider text-purple-400 mb-1">1. User visits</div>
                    <code className="text-xs">
                      <span className="text-purple-400 font-semibold">globex</span>
                      <span className="text-neutral-600">---</span>
                      <span className="text-neutral-400">{previewUrl}</span>
                    </code>
                  </div>
                  ...
                  <div className="rounded border border-neutral-700 bg-neutral-800/50 px-3 py-2">
                    <div className="text-[10px] uppercase tracking-wider text-neutral-400 mb-1">3. Your code receives</div>
                    <code className="text-xs text-neutral-300">
                      host: <span className="text-purple-400 font-semibold">globex</span>
                      <span className="text-neutral-600">---</span>
                      <span className="text-neutral-500">{previewUrl}</span>
                    </code>
                  </div>
              ...
              <p className="text-xs text-neutral-400 border-t border-neutral-800 pt-4 mt-5">
                Both URLs route to the <em className="text-neutral-300 not-italic">same deployment</em>. 
                Your code extracts the prefix and handles routing however you want—middleware, rewrites, or custom logic.
              </p>
            </div>
          </>
        ) : (
          <>
              ...
              <code className="bg-neutral-800 px-2 py-1 rounded">
                {host ? (
                  <>
                    ...
                    <span className="text-neutral-500">---{host.split('---')[1] || host}/</span>
                  </>
                ) : ""}
              </code>
            </p>
            ...
            <h2 className="mt-12 text-sm font-medium text-neutral-300">
              Navigation
            </h2>
            <p className="mt-1 text-sm text-neutral-400">
              These links use relative paths. They stay within the current
